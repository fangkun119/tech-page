...
> 其中订单服务其实既是TM（事务发起者）又是RM（资源管理者），为了清晰展示，将它拆分成两部分

<img src="/imgs/spring-cloud-alibaba-mvp-03-env/21480026aaa3c283410013cfccec9df3_MD5.jpg" style="display: block; width: 100%;" alt="Seata AT事务一阶段">
###### 第二阶段：提交或回滚
...
<img src="/imgs/spring-cloud-alibaba-mvp-03-env/ea7c33a9ddbde8b16e817089e28a0040_MD5.jpg" style="display: block; width: 100%;" alt="全局事务提交">
...
<img src="/imgs/spring-cloud-alibaba-mvp-03-env/20a3d9c7b449193d104c0d9df0659534_MD5.jpg" style="display: block; width: 100%;" alt="全局事务回滚">
...
共三步：下载 Seata → 数据库建表 → 创建专属 Nacos 命名空间
...
接下来向Nacos上传Seata所需的远程配置，用于实现**配置托管**和**动态更新**。
...
打开 **Nacos控制台**（`http://tlmall-nacos-server:8848/nacos/`），找到在章节 `4.2.(3)` 创建的 **Seata 专用命名空间**。
...
在"配置管理" → "配置列表"中，将命名空间切换至 **seata**，点击"创建配置"。
